    ...
    <>
      ...
      <ul className="max-w-2xl mx-auto w-full gap-4">
        {cards.map((card, index) => (
            ...
            className={`p-4 flex flex-col md:flex-row justify-between items-center hover:bg-neutral-50 dark:hover:bg-neutral-800 rounded-xl cursor-pointer transition-colors duration-300`}
            >
            ...
            <motion.button
              ...
              className="px-4 py-2 text-sm rounded-full font-bold bg-gray-100 hover:bg-black hover:text-white text-black mt-4 md:mt-0 border border-gray-600 transition-colors duration-300"
            >
              {card.ctaText}
            </motion.button>
            </motion.div>
...
const cards = [
  {
    description: "Effortless Flight Booking, Elevated Experiences!",
    title: "Sky_Connect",
    src: "/airplane.jpg",
    ctaText: "CODE",
    ctaLink: "https://github.com/AbdulhameedSk/SkyConnect",
    content: () => {
      return (
        <ul>
...
{
  description: "Bridging Alumni, Building Futures.",
    title: "AlumNexus",
    src: "/alumni.jpg",
    ctaText: "VISIT",
    ctaLink: "https://alumni-network-platform.vercel.app/",
    content: () => {
      return (
